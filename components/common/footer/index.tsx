...
import markupLogo from "@/public/logos/gosummit-icon.png";
  ...
  return (
    ...
    >
      <div className="container  mx-auto relative">
        <div className="grid grid-cols-1 gap-14 py-2 lg:py-4 md:grid-cols-2 lg:grid-cols-4 xl:grid-cols-5">
            ...
            <div className="flex space-x-3 rtl:space-x-reverse justify-center md:justify-start ">
              {SOCIAL_LINKS.map((social) => (
                <Link
                  ...
                  className={`w-10 h-10 flex items-center justify-center rounded-xl bg-slate-700 dark:bg-blue-900/20 dark:hover:bg-blue-950 text-white hover:bg-red-800 hover:text-white transition-all duration-300 ${social.bgColor} shadow-sm hover:shadow-md border border-gray-200 dark:border-blue-800/50`}
                >
                  <div>{social.icon}</div>
                </Link>
              ))}
          ...
          <div className="space-y-8">
            <h3 className="text-lg font-bold text-gray-900 dark:text-white flex items-center">
              <span className="w-2.5 h-2.5 bg-blue-900 rounded-full mr-3 rtl:mr-0 rtl:ml-3"></span>
        ...
        {/* Copyright Section */}
        <div className="border-t border-gray-200 dark:border-blue-800/50 py-4 flex flex-col md:flex-row justify-between items-center gap-4">
          <div className="text-gray-500 dark:text-blue-200 text-sm">
            <Link
              href={"https://www.markup.vip"}
              target="_blnk"
              className="text-gray-500 dark:text-blue-200 text-[12px]  lg:text-sm flex items-center "
            >
              <div className="bg-white w-10 h-10 rounded-full border-4 border-gray-200 flex items-center justify-center mx-2 shadow-md">
                <Image
                  src={markupLogo}
                  alt="Markup Agency"
              ...
              &copy; {currentYear} Go-Summit Agency{" "}
          ...
          <div className="flex flex-wrap justify-center gap-x-6 gap-y-2">
            ...
            <Link
              href="/terms"
              className="text-gray-500 dark:text-blue-200 hover:text-red-600 dark:hover:text-red-400 transition-colors duration-300 text-sm"
            >
