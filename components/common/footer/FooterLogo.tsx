...
const FooterLogo = () => {
  ...
  return (
    <Link href="/" className="inline-block" aria-label="Mansour Sweets">
      <div className="w-24 h-24 bg-white dark:bg-blue-900/20 rounded-2xl  shadow-xl dark:shadow-blue-900/30 flex items-center justify-center border border-gray-200 dark:border-blue-800/50 mx-auto md:mx-0">
        <Image
