import ExperienceClient from "@/components/Action-Interface/Admin/ActionUi/AdminExperience/AdminExperienceClient";
...
const ExperiencePage = async () => {
  ...
  const formatted: IDraggableType[] = experience
    .map((item) => ({
      id: item.id,
      titleEn: item.title,
      titleAr: item.subtitle,
    ...
    <>
      <div className="flex-col w-full">
        <div className="flex-1 space-y-4 p-8 pt-6">
          <ExperienceClient data={formatted} />
        </div>
      </div>
