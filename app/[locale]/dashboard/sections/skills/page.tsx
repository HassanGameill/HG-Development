...
import SkillsClient from "@/components/Action-Interface/Admin/ActionUi/Skills/SkillsClient";
...
const SkillsPage = async () => {
  ...
  const formatted: IDraggableType[] = skills
    .map((item) => ({
      id: item.id,
      nameEn: item.nameEn,
      nameAr: item.nameEn,
